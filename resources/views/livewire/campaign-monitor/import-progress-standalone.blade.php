...
<div
     @if($import && $import->storage_path) wire:init="startImport" @endif
     @if(!$isComplete && !$hasError) wire:poll.1s="refreshImport" @endif
     class="min-h-screen py-8 bg-gray-50"
     x-data="{
         isComplete: @js($isComplete),
         hasError: @js($hasError)
     }"
     x-init="
         $watch('$wire.isComplete', value => isComplete = value);
         $watch('$wire.hasError', value => hasError = value);
     ">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            ...
            <div class="mb-6 flex items-center">
                <!-- Loading Icon -->
                <div x-show="!isComplete && !hasError" class="mr-3">
                ...
                <!-- Success Icon -->
                <div x-show="isComplete && !hasError"
            ...
            @if($import)
                ...
                <div class="mb-8">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-4 rounded-full transition-all duration-500 ease-out"
                             ...
                             x-bind:class="{ 'bg-gradient-to-r from-green-500 to-green-600': isComplete && !hasError }">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <!-- Failed -->
                    <div class="bg-red-50 p-4 rounded-lg border border-red-100 transition-all duration-300 hover:shadow-md"
                         x-bind:class="{ 'ring-2 ring-red-300': {{ $import->failed_count }} > 0 }">
